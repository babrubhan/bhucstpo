        ...
        <td>
          <form role="form" action="php/search.php" method="get">
             <div class="form-group">
              ...
              <input id="searchByName" class="form-control" type="text" name="name" placeholder="Eg : Babru">
            </div>
            <div class="form-group">
              <label for="searchByRoll">Search by Enrollment number</label>
              <input id="searchByRoll" class="form-control" type="text" name="Enroll" placeholder="Eg : 380014">
            </div>
        ...
        <td>
          ...
          <form role="form" action="php/addstudents.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="studentName" name="name" placeholder="Eg : Babru">
            </div>
            <div class="form-group">
              <label for="studentRoll">Enrollment Number </label>
              <input type="text" class="form-control" id="studentRoll" name="Enroll" placeholder="Eg : 380014">
            </div>
            <div class="form-group">
